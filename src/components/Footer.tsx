      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-neutral-400 mb-4 max-w-md">
              Discover unique vintage and designer fashion pieces. Quality pre-loved clothing and accessories for the conscious fashionista.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/categories/dresses" className="hover:text-primary-400 transition-colors">Dresses</Link></li>
              <li><Link href="/categories/tops" className="hover:text-primary-400 transition-colors">Tops</Link></li>
              <li><Link href="/categories/bags" className="hover:text-primary-400 transition-colors">Bags</Link></li>
              <li><Link href="/sale" className="hover:text-primary-400 transition-colors">Sale</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-neutral-800 mt-8 pt-8 text-center">
          <p className="text-neutral-400">
            © 2024 Baddie Thrift. All rights reserved. Sustainable fashion for the modern baddie.
          </p>
        </div>
      </div>
    </footer>
